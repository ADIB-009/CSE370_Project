...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2025 at 04:30 PM
...
('Ryzen 5 7400F', 'AMD', 14799, 6, 12, 3.70, 4.70),
...
('5', 'Ryzen 5 7400F', 'Radeon RX 7700 XT', 'V6', 'B450M-KII', '990 Pro', 'PL750D');
...
--
ALTER TABLE `pc_specification`
  ADD CONSTRAINT `pc_specification_ibfk_1` FOREIGN KEY (`pc_id`) REFERENCES `pc` (`id`),
  ADD CONSTRAINT `pc_specification_ibfk_2` FOREIGN KEY (`cpu_sku`) REFERENCES `cpu` (`cpu_sku`),
  ADD CONSTRAINT `pc_specification_ibfk_3` FOREIGN KEY (`gpu_sku`) REFERENCES `gpu` (`gpu_sku`),
  ADD CONSTRAINT `pc_specification_ibfk_4` FOREIGN KEY (`ram_sku`) REFERENCES `ram` (`ram_sku`),
  ADD CONSTRAINT `pc_specification_ibfk_5` FOREIGN KEY (`mobo_sku`) REFERENCES `motherboard` (`mobo_sku`),
  ADD CONSTRAINT `pc_specification_ibfk_6` FOREIGN KEY (`s_sku`) REFERENCES `storage` (`s_sku`),
  ADD CONSTRAINT `pc_specification_ibfk_7` FOREIGN KEY (`pwr_sku`) REFERENCES `power_supply` (`pwr_sku`);
COMMIT;
